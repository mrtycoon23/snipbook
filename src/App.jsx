  ...
  async function saveLog(logData){
    try{
      ...
      if(phone10.length===10){
        ...
        setWaStatus("sending");
        try{
          const r=await fetch("/api/send-summary",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({customerPhone:phone10,customerName:logData.clientName,salonName:salonName,visit:{date:logData.date,services:[logData.service],amount:logData.amount,notes:logData.notes||"",photos:logData.photos||[]}})});
