...
function Onboarding({onComplete,onBack}){
  ...
  return(<div style={{minHeight:"100vh",background:`linear-gradient(135deg,${TP.purpleLight},#fff)`,display:"flex",flexDirection:"column",alignItems:"center",padding:"20px 16px 40px",fontFamily:"system-ui,sans-serif",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch",overflowY:"auto",WebkitOverflowScrolling:"touch"}}><div style={{marginBottom:18,display:"flex",alignItems:"center",gap:8}}><div style={{width:36,height:36,background:TP.purple,borderRadius:10,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18}}>✂️</div><span style={{fontWeight:900,fontSize:18,color:TP.text}}>Snip<span style={{color:TP.purpleMid}}>Book</span></span></div><div style={{width:"100%",maxWidth:460,marginBottom:6}}><div style={{display:"flex",justifyContent:"space-between",fontSize:12,fontWeight:700,color:"#888",marginBottom:6}}><span>Step {step} of {OB_STEPS.length}</span><span style={{color:TP.purple}}>{Math.round(progress)}% done</span></div><div style={{background:TP.border,borderRadius:20,height:6,overflow:"hidden"}}><div style={{width:`${progress}%`,height:"100%",background:`linear-gradient(90deg,${TP.purple},${TP.purpleMid})`,borderRadius:20,transition:"width 0.4s"}}/></div></div><div style={{display:"flex",width:"100%",maxWidth:460,marginBottom:18}}>{OB_STEPS.map((s)=>(<div key={s.id} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:3,cursor:s.id<step?"pointer":"default"}} onClick={()=>{if(s.id<step)setStep(s.id);}}><div style={{width:24,height:24,borderRadius:"50%",background:step>s.id?TP.purple:step===s.id?TP.text:TP.border,color:step>=s.id?"#fff":"#aaa",display:"flex",alignItems:"center",justifyContent:"center",fontSize:step>s.id?11:10,fontWeight:800,border:step===s.id?`3px solid ${TP.purple}`:"3px solid transparent"}}>{step>s.id?"✓":s.id}</div><div style={{fontSize:8,fontWeight:700,color:step===s.id?TP.purple:"#ccc"}}>{s.icon}</div></div>))}</div>
