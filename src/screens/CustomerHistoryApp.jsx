    ...
    <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",background:T.bg}}>
      ...
      <div style={{flex:1,overflowY:"auto",padding:"14px 14px 80px",background:T.bg}}>
        ...
        {tab==="overview"&&<>
          ...
          <div style={{display:"flex",gap:10}}><button onClick={()=>setBookModal(true)} style={{flex:1,padding:12,background:T.purple,border:"none",borderRadius:12,color:"#fff",fontFamily:"inherit",fontSize:13,fontWeight:800,cursor:"pointer"}}>📅 Book</button><button onClick={()=>customer.phone&&window.open(`https://wa.me/91${customer.phone}`,"_blank")} style={{flex:1,padding:12,background:T.wa,border:"none",borderRadius:12,color:"#fff",fontFamily:"inherit",fontSize:13,fontWeight:800,cursor:"pointer"}}>💬 WhatsApp</button></div>
        </>}
        {tab==="visits"&&<>
