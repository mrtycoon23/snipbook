...
const S={
  ...
  bc:{flex:1,padding:11,border:"1px solid #e2e8f0",background:"#f8fafc",borderRadius:10,fontSize:14,fontWeight:600,color:"#1a1a2e",cursor:"pointer",fontFamily:"inherit"},
